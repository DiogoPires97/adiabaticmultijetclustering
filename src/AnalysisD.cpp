...
string filename0("/Users/diogopires/Desktop/jets/Diogo/Results/results0_classical");
string filename1("/Users/diogopires/Desktop/jets/Diogo/Results/results1_classical");
...
for(int f = 0; f < file_n; f++){
  ...
  ///////////////////////////////////////////////////////////////
  //Load classical Fastjet results
  ...
  infile.open(filename0+to_string(f)+format);
    ...
    while(infile >> jet0) // reads file to end of *file*, not line
    {   
  ...
  infile.open(filename1+to_string(f)+format);
    ...
    while(infile >> jet1) // reads file to end of *file*, not line
    {   
...
////////////////////// Plot Results Data (Histogram)

write.open("/Users/diogopires/Desktop/jets/Diogo/Results/plot_data_QBC.txt");
